...
//        for (int i = 1; i <= 10; i++) {
            ...
            article.setId(101);
            article.setTitle("我的名字是张翔");
            article.setContent("我家在桐城");
            //把文档写入索引库
...
//        }
    ...
    public void deleteDocumentById() throws Exception {
        articleRepository.deleteById(11l);  // long类型，后面加了l(L)
        //全部删除
    ...
    public void testFindByTitle() throws Exception {
        List<Article> list = articleRepository.findByTitle("elasticsearch是一个工程构建工具");
    ...
    public void testNativeSearchQuery() throws Exception {
        ...
        NativeSearchQuery query = new NativeSearchQueryBuilder()
                .withQuery(QueryBuilders.queryStringQuery("elasticsearch 是一个工程构建工具").defaultField("title"))
