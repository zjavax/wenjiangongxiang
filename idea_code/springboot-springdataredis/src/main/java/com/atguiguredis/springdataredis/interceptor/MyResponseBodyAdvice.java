...
import com.atguiguredis.springdataredis.controller.HelloController;
...
public class MyResponseBodyAdvice implements ResponseBodyAdvice {
    ...
    public boolean supports(MethodParameter returnType, Class converterType) {
        ...
        if (returnType.hasMethodAnnotation(PostMapping.class) &&
                returnType.getExecutable().getDeclaringClass().getName().equals(HelloController.class.getName())) {
            return true;
        }
